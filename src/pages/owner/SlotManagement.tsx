...
const emptyForm = { startTime: '', endTime: '', pricePerHour: '', status: 'AVAILABLE' };
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-gray-50 border-b border-gray-100">
                  <tr>{[t('startTime'), t('endTime'), t('status'), t('pricePerHour'), t('actions')].map((h) => (
      ...
      {modal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-2xl">
            <h3 className="font-bold text-gray-800 text-lg mb-4">{modal === 'create' ? t('addSlot') : t('editSlot')}</h3>
