    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Revenue from your playgrounds</p>
        </div>
        <button
        ...
        <>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            {data?.periodBreakdown?.length ? (
              ...
              <div className="h-40 flex items-center justify-center text-gray-400 text-sm">No revenue data for selected period</div>
            )}
          </div>
                ...
                <table className="w-full text-sm">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-5 py-3 text-right font-medium text-gray-500">Bookings</th>
