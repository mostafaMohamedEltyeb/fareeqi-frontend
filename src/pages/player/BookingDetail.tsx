      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
        ...
        {booking.status === 'APPROVED' && booking.paymentStatus === 'PAID' ? (
          <div className="mt-6 border-t border-gray-100 pt-5">
            <p className="text-sm font-semibold text-gray-700 mb-1">{t('showQr')}</p>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex items-center gap-2 bg-gray-50 rounded-lg px-3 py-2 w-full">
                ...
                <button onClick={copy} className="p-1 text-gray-400 hover:text-green-600 flex-shrink-0">
          ...
          <div className="mt-5">
            ...
            <p className="text-xs text-gray-400 mt-1">{isRTL ? 'سيظهر رمز QR بعد الموافقة والدفع' : 'QR code will appear after approval and payment'}</p>
          </div>
        )}
        {booking.status === 'APPROVED' && booking.paymentStatus !== 'PAID' && (
