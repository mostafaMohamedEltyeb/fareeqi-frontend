      ...
      {loading ? <LoadingSkeleton rows={6} /> : (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { title: t('totalRevenue'), value: fmt(data?.totalRevenue), icon: TrendingUp, color: 'bg-green-50 text-green-600' },
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {data.playgroundBreakdown.map((pg, i) => {
                      const share = data.totalRevenue > 0
                        ? ((Number(pg.revenue) / Number(data.totalRevenue)) * 100).toFixed(1) : '0.0';
                      return (
                  ...
                  <tfoot className="bg-gray-50 border-t border-gray-100">
                    <tr>
                      ...
                      <td className="px-5 py-3 text-end font-bold text-green-700">{fmt(data.totalRevenue)}</td>
